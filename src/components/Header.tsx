      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-[11px] sm:text-xs text-slate-500 font-normal">
              Asistent didactic pentru planificări curriculare & proiecte de lecție
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          <button
            ...
            type="button"
            className="inline-flex items-center px-3 py-1.5 text-xs font-semibold rounded-lg text-[#0D9488] bg-[#F0FDFA] hover:bg-[#CCFBF1] border border-[#99F6E4] transition-all duration-200 cursor-pointer"
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center px-3 py-1.5 text-xs font-medium rounded-lg text-[#1E293B] bg-slate-50 hover:bg-slate-100 border border-[#E2E8F0] transition-all duration-200 cursor-pointer"
